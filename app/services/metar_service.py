...
async def fetch_metar_taf_wicc() -> Dict[str, Any]:
    async with httpx.AsyncClient(timeout=10.0) as client:
        ...
        ext_res = await client.get(OPEN_METEO_EXTENDED)
        ext_data = ext_res.json() if ext_res.status_code == 200 else {}
        ...
        return {
            ...
            "upper_wind": ext_data.get("current", {}),
            "daily_ext": ext_data.get("daily", {}),
            "minutely_15": ext_data.get("minutely_15", {})
        }